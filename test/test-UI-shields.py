...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        aLayout = QVBoxLayout(self.canvas)
        aLayout.setDirection(QBoxLayout.Direction.BottomToTop)
        aLayout.setAlignment(Qt.AlignmentFlag.AlignBottom)
        aLayout.addWidget(QPushButton("TEST"))
