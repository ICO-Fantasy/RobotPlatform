...
# end class
class AIS_Shape_Trihedron(AIS_MultipleConnectedInteractive):
    def __init__(self, shape):
        super().__init__()
        self._ais_shape = AIS_Shape(shape)
        self._ais_trihedron = createTrihedron(self._ais_shape)
        self.Connect(self._ais_shape)
        self.Connect(self._ais_trihedron)
...
def test(gui: MainWindow):
    ...
    ========================================================================================
    """
    box_shape = BRepPrimAPI_MakeBox(10.0, 10.0, 20.0).Shape()
    ais_box = AIS_Shape_Trihedron(box_shape)
