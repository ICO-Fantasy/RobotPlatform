...
def test(gui: MainWindow):
    ...
    ========================================================================================
    """
    box_shape_1 = read_step(r"outs\CPlate.STEP")
    box_shape_2 = read_step(r"outs\1.STEP")
    box_shape_3 = read_step(r"outs\0.STEP")
    # ais_box_1 = AIS_Shape(box_shape_1)
    # ais_box_2 = AIS_Shape(box_shape_2)
    # ais_box_3 = AIS_Shape(box_shape_3)
    # gui.display(ais_box_1, True)
    # gui.display(ais_box_2, True)
    # gui.display(ais_box_3, True)

    fusser_1 = BRepAlgoAPI_Fuse(box_shape_1, box_shape_2)
    fusser_1.SimplifyResult()
    # gui.display(AIS_Shape(fusser_1.Shape()), True)

    fusser_2 = BRepAlgoAPI_Fuse(fusser_1.Shape(), box_shape_3)
    fusser_2.SimplifyResult()
    gui.display(AIS_Shape(fusser_2.Shape()), True)
