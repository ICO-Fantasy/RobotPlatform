...
from ..DataExchange import COLOR
...
class AIS_Arrow(AIS_MultipleConnectedInteractive):
    def __init__(
        ...
        self.arrow_color = COLOR(arrow_color)()
        # 创建锥体和圆柱体
        self._makeCone()
        self._makeCylinder()
        # 设置颜色
        self.SetColor(COLOR(arrow_color)())
        # 连接锥体和圆柱体
    ...
    def _makeCylinder(self):
        ...
        cylinder = BRepPrimAPI_MakeCylinder(
            axis, self.r_size, self.arrow_length - self.arrow_high
        ).Shape()
...
if __name__ == "__main__":
    display, start_display, add_menu, add_function_to_menu = init_display(
        size=(1920, 980), display_triedron=True
    )
